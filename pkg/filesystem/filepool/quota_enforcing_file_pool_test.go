...
func testRemainingQuota(t *testing.T, ctrl *gomock.Controller, underlyingPool *mock.MockFilePool, pool filepool.FilePool, filesRemaining int, bytesRemaining int64) {
...
func TestQuotaEnforcingFilePoolExample(t *testing.T) {
	...
	pool := filepool.NewQuotaEnforcingFilePool(underlyingPool, 10, 1000)
